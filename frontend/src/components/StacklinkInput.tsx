        ...
        <div className="bg-white shadow-sm p-5 flex flex-wrap items-center gap-5">
            ...
            <Switch
                ...
                className={classNames(
                    ...
                    'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-brand-3 focus:ring-offset-2 hover:bg-brand-2'
                )}
            >
                <span
                    aria-hidden="true"
